...
def test_get_greenlist_ids_list(input_ids_list, hpu_device):
    processor = WatermarkLogitsProcessor(device=hpu_device)
...
def test_calc_greenlist_mask_list(scores, hpu_device):
    processor = WatermarkLogitsProcessor(device=hpu_device)
...
def test_call_list(input_ids_list, scores, hpu_device):
    processor = WatermarkLogitsProcessor(device=hpu_device)
